...
class CustomFilterBottomSheetStyles extends StatelessWidget {
  CustomFilterBottomSheetStyles({Key? key}) : super(key: key);
      ...
      return Stack(
        ...
        children: [
          AnimatedSwitcher(
            ...
            child: stylesDetailsController.filterOpenMenu.value
                ? GestureDetector(
                    onTap: () {
                      stylesDetailsController.filterOpenMenu.value = false;
                    },
                    child: Container(
          ...
          AnimatedPositioned(
            bottom: stylesDetailsController.filterOpenMenu.value
                ? 0
                : -Get.height * 0.6,
            ...
            itemBuilder: (BuildContext context, index) {
              return Obx(() {
                return GestureDetector(
                  onTap: () {
                    stylesDetailsController.addOrRemoveFilterCategory(index);
                  },
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                        color:
                            stylesDetailsController.checkCategorySelect(index)
                                ? primaryColor
                                : Colors.transparent,
                        ...
                        Container(
                          ...
                          child: Text(
                            ...
                            initController.categoriesList[index].title
                                .toString()
                            : initController.categoriesList[index].arTitle.toString(),
                            style: stylesDetailsController
                                    .checkCategorySelect(index)
          ...
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, index) {
              return Obx(() {
                return GestureDetector(
                  onTap: () {
                    stylesDetailsController.addOrRemoveFilterStyle(index);
                  },
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: stylesDetailsController.checkStyleSelect(index)
          ...
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, index) {
              return Obx(() {
                return GestureDetector(
                  onTap: () {
                    stylesDetailsController.addOrRemoveFilterMoodboard(index);
                  },
                  child: AnimatedContainer(
